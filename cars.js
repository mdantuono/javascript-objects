...
function details() {
    ...
    if(elem == "economy") {
        document.getElementById('price').innerHTML = "Price: $" + carRental.carType[0].price + "  Available: " + carRental.carType[0].amount;
    }
    else if (elem == "midsize") {
        document.getElementById('price').innerHTML = "Price: $" + carRental.carType[1].price + "  Available: " + carRental.carType[1].amount;
    }
    else if (elem == "luxury") {
        document.getElementById('price').innerHTML = "Price: $" + carRental.carType[2].price + "  Available: " + carRental.carType[2].amount;
    }
}
